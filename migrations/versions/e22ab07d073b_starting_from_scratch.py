...
Revision ID: e22ab07d073b
Revises: 
Create Date: 2018-12-06 10:51:33.393100
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('bigg_acronym', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('bigg_acronym'),
    ...
    sa.Column('enzyme_organism_id', sa.Integer(), nullable=True),
    sa.Column('gene_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['enzyme_organism_id'], ['enzyme_organism.id'], ),
    ...
    sa.Column('met_comp_acronym', sa.String(), nullable=True),
