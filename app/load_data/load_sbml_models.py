...
Copyright 2014 Centre of Biological Engineering,
University of Minho.

Copyright 2016 European Molecular Biology Laboratory.
...
def _load_reaction(reaction, sbml_model, exchange_detection_mode=None, load_metadata=True):
    ...
    Returns:
        a reaction tuple of the form (reaction id, reaction name, reaction reversibility, stoichiometry, modifiers,
         is_exchange)
    """
